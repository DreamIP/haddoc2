...
gpnode connect -f cnn.out0 -t usb.in1
gpnode connect -f cnn.out1 -t usb.in1
gpnode connect -f cnn.out2 -t usb.in1
gpnode connect -f cnn.out3 -t usb.in1
gpnode connect -f cnn.out4 -t usb.in1
gpnode connect -f cnn.out5 -t usb.in1
gpnode connect -f cnn.out6 -t usb.in1
gpnode connect -f cnn.out7 -t usb.in1
gpnode connect -f cnn.out8 -t usb.in1
gpnode connect -f cnn.out9 -t usb.in1
